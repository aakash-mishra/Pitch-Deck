...
if( isset( $_POST['submit'] ) ){
  ...
  $link = $_POST['link'];
  $sql = "INSERT INTO Users VALUES('$name', '$email', '$mobile', '$message', '$link', '$ppt', '' )";
...
<div id="skipnav"><a href="#maincontent">Skip to main content</a></div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <form action="index.php#contact" method="post" name="sentMessage" enctype="multipart/form-data" id="contactForm">
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label for="name">Name/Company Name</label>
                                <input type="text" class="form-control" placeholder="Name/Company Name*" name="name" id="name" data-validation-required-message="Please enter your name." required>
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="email" class="form-control" placeholder="Email Address*" name="email" id="email" data-validation-required-message="Please enter your email address." required>
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="row control-group">
    ...
    <!-- Simple Upload -->
    <!-- <script src="node_modules/jquery-simple-upload/simpleUpload.min.js"></script> -->
